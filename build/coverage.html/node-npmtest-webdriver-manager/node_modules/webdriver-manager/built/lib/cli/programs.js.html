...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-webdriver-manager/node_modules/webdriver-manager/built/lib/cli/programs.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-webdriver-manager/node_modules/webdriver-manager/built/lib/cli/programs.js</span></h1>
    <h2>
        
        Statements: <span class="metric">78.95% <small>(75 / 95)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">78.95% <small>(75 / 95)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-webdriver-manager/node_modules/webdriver-manager/built/lib/cli/</a> &#187; programs.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >        return tempJson;</span>
    ...
    printCmd(opt_posDescription) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (opt_posDescription) {
            let diff = opt_posDescription - log.length;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (diff &lt; Program.MIN_SPACING) {
...
<span class="cstat-no" title="statement not covered" >                    spacing = Program.MIN_SPACING;</span>
            ...
            console.log(log);
            <span class="missing-if-branch" title="else path not taken" >E</span>if (opt_extOptions) {
...
<span class="cstat-no" title="statement not covered" >        this.printOptions(this.posDescription(), this.posDefault());</span>
    ...
    lengthOf_(param) {
        ...
        for (let opt in this.options) {
            ...
            else <span class="missing-if-branch" title="else path not taken" >E</span>if (param === 'opt') {
    ...
    getMinimistOptions() {
        ...
        for (let opt in allOptions) {
            ...
            else <span class="missing-if-branch" title="else path not taken" >E</span>if (option.type === 'number') {
